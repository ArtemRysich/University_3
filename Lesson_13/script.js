...
//  value.addEventListener('click', handlerGetColor)
// })
...
// container.addEventListener("click", handlerGetColor, true);
...
// red.addEventListener('click', handlerClick, true);
// green.addEventListener('click', handlerClick, true);
// black.addEventListener('click', handlerClick, true)
...
// red.addEventListener("click", firstHandlerClick, true);
...
container.addEventListener("click", handlerGetProduct);
...
function handlerGetProduct(evt) {
  ...
  const { productId } = currentProduct.dataset;
